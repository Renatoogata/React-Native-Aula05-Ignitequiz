...
export function Stars() {
    ...
    const backStartsBlinkAnimation = useLoop({ // efeito de piscar
        duration: 2000,
        easing: Easing.ease
    });

    const frontStartsBlinkAnimation = useLoop({ // efeito de piscar
        duration: 3000,
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <Path
                    opacity={frontStartsBlinkAnimation}
                ...
                <Path
                    opacity={backStartsBlinkAnimation}
